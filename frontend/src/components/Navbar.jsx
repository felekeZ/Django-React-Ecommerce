        ...
        <div className="flex justify-between items-center">
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`relative transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-3 ${
          ...
          <div className={`rounded-2xl p-4 ${
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className={`h-px w-full my-2 ${
                scrolled ? "bg-gradient-to-r from-transparent via-gray-200 to-transparent" : "bg-gradient-to-r from-transparent via-white/30 to-transparent"
              }`}></div>
